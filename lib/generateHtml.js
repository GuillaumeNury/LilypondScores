                  ...
                  .map(
                    score =>
                      `<tr>
                            ...
                            <td>
                                ${score.midiFile
                                    ? `<a href="./${theme.folder + (additionnalPath || "")}/${score.midiFile}" target="_blank"><i class="fas fa-music"></i></a>`
                                    : ''}
                                <a href="./${theme.folder + (additionnalPath || "")}/${score.matchingFile}" target="_blank"><i class="fas fa-eye"></i></a>
                                <a href="./${theme.folder + (additionnalPath || "")}/${score.matchingFile}" download><i class="fas fa-download"></i></a>
                            </td>
                        </tr>`
                  )
                  .join("")}
